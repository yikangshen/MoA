...
class MoaTransformerModel(TransformerModelBase):
    """
    This is the implementation of the moa transformer model that
    ...
    #     parser.add_argument(
    #         '--num-expert', type=int, default=12,
    #         help='number of experts in each moa layer',
    #     )
...
# architectures
@register_model_architecture("moa_transformer", "moa_transformer_base")
def base_ende_architecture(args):
    ...
    args.gating = getattr(args, "gating", 'normal')
    args.ffd_type = getattr(args, "ffd_type", 'normal')
