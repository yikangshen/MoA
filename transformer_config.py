...
class EncDecBaseConfig(FairseqDataclass):
    ...
    num_expert: int = field(default=12, metadata={"help": "number of experts in each moa layer"})
...
class TransformerConfig(FairseqDataclass):
    ...
    num_expert: int = field(
        default=12,
        metadata={
            "help": "number of experts used in each layer.",
        },
    )
    head_dim: int = field(
        default=256,
    ...
    gating: Optional[str] = field(
        default="normal",
        metadata={
            "help": "gating mechanism.",
        },
    )
    ffd_type: Optional[str] = field(
        default="normal",
        metadata={
            "help": "ffd mechanism.",
        },
